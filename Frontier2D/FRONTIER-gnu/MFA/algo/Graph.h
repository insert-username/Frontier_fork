...
public:
    ...
    static int copyG(Graph &g0, Graph &g1) {
    ...
    static int extension(GlobalState &globalState, Graph &F, Graph &graph0, std::ostream &file1, std::ostream &file2) {
        Vertex v0, v1;
        Edge edge;
    ...
    static Cluster* getCluster(GlobalState &globalState, Graph &F, Graph &graph0) {
